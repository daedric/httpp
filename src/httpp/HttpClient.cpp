...
HttpClient::handle_request(HTTP::Method method, Request request, CompletionHandler completion_handler)
{
...
#define METHOD(m)                                                                                          \
    ...
    HttpClient::AsyncHandler HttpClient::async_##m(Request request, CompletionHandler completion_handler)  \
    {                                                                                                      \
        return handle_request(HTTP::Method::METHOD_##m, std::move(request), std::move(completion_handler)) \
            .second;                                                                                       \
    }
