...
macro (libfind_process PREFIX)
  ...
  if (NOT ${PREFIX}_FOUND)
    ...
    foreach (i ${${PREFIX}_PROCESS_INCLUDES})
      if (${i})
        set (${PREFIX}_INCLUDE_DIRS ${${PREFIX}_INCLUDE_DIRS} ${${i}} CACHE string "${PREFIX} include directories")
        mark_as_advanced(${i})
      else (${i})
    ...
    foreach (i ${${PREFIX}_PROCESS_LIBS})
      if (${i})
        set (${PREFIX}_LIBRARIES ${${PREFIX}_LIBRARIES} ${${i}} CACHE string "${PREFIX} libraries" FORCE)
        mark_as_advanced(${i})
      else (${i})
        set (${PREFIX}_FOUND FALSE)
      endif (${i})
    ...
    if (${PREFIX}_FOUND)
      ...
      set(${PREFIX}_FOUND TRUE CACHE BOOL "${PREFIX} was found" FORCE)
      mark_as_advanced(${PREFIX}_FOUND ${PREFIX}_LIBRARIES ${PREFIX}_INCLUDE_DIRS)
