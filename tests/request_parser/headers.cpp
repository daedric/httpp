...
BOOST_AUTO_TEST_CASE(parser_streambuf)
{
    ...
    BOOST_CHECK_EQUAL(request.headers[0],
                      HTTPP::HTTP::Header("Test", "coucou"));
    ...
    BOOST_CHECK_EQUAL(request.headers[3],
                      HTTPP::HTTP::Header("Hello", "world!"));
    BOOST_CHECK_EQUAL(request.headers[4], HTTPP::HTTP::Header("Incomplete2", ""));
    BOOST_CHECK_EQUAL(request.headers[5],
                      HTTPP::HTTP::Header("Test2", "Test3"));
}
#else
